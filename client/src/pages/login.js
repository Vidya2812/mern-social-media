  ...
  return (
    <div className="auth_page">
      <form onSubmit={handleSubmit} className="">
        <h3 className="text-uppercase text-center mb-4 auth-heading "><img style={{width:"20%",height:"30%"}} src={logo1}/ >
        Connect
        </h3>
        <div className="mb-3">
        ...
        <div className="d-flex justify-content-evenly  mx-0 mb-4">
          <label htmlFor="User" style={{color:'white'}}>
            ...
            <input
              ...
              value={userType}
              defaultChecked
              onClick={() => setUserType(false)} style={{marginLeft:'7px',marginTop:'14px'}}
            />
          </label>

          <label htmlFor="Admin" style={{color:'white'}}>
            Admin:
            <input
              type="radio"
              id="Admin"
              name="gender"
              value={userType}
              onClick={() => setUserType(true)} style={{marginLeft:'7px',marginTop:'14px'}}
            />
          </label>
        </div>
